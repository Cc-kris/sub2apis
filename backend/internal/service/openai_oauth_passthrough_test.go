...
func TestOpenAIGatewayService_OAuthPassthrough_UpstreamRequestCancelsBeforeResponseStarts(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
func TestOpenAIGatewayService_OAuthLegacy_UpstreamRequestCancelsBeforeResponseStarts(t *testing.T) {
	gin.SetMode(gin.TestMode)
