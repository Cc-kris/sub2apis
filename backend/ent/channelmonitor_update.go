...
func (_u *ChannelMonitorUpdate) SetMode(v string) *ChannelMonitorUpdate {
	_u.mutation.SetMode(v)
	return _u
}

// SetNillableMode sets the "mode" field if the given value is not nil.
func (_u *ChannelMonitorUpdate) SetNillableMode(v *string) *ChannelMonitorUpdate {
	if v != nil {
		_u.SetMode(*v)
	}
	return _u
...
// SetMode sets the "mode" field.
func (_u *ChannelMonitorUpdateOne) SetMode(v string) *ChannelMonitorUpdateOne {
	_u.mutation.SetMode(v)
	return _u
}

// SetNillableMode sets the "mode" field if the given value is not nil.
func (_u *ChannelMonitorUpdateOne) SetNillableMode(v *string) *ChannelMonitorUpdateOne {
	if v != nil {
		_u.SetMode(*v)
	}
	return _u
